...
public class Course
{
    ...
    // A variable so that a course can contain 1 module
    ...
    /**
     * Prints the details of the course, the list of students enrolled and the module
     */
    public void print()
    {
        printHeading();
    ...
    /**
     * This adds a module and its details to a course
